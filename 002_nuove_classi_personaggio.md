...
Gli Assassini possono acquisire e usare il Veleno. Una dose di Veleno costa 50po. Il veleno può essere messo nel cibo o nelle bevande o applicato ad un'arma affilata (incluse frecce e quadrelli). Se un bersaglio subisce qualsiasi danno da un'arma avvelenata, deve salvarsi dal Veleno o morire. Il Veleno viene rimosso dall'arma, che il bersaglio muoia o meno.
...
Nella vostra forma di piccolo animale non potete parlare, perdete tutto l'equipaggiamento, non potete usare nessun oggetto o combattere, ma siete più agili e potete raggiungere luoghi inaccessibili ai normali umanoidi.
...
I Monaci di solito viaggiano per la terra in cerca di degni avversari. Ogni Monaco si è addestrato in un monastero, che ha le proprie regole, filosofie e tecniche di combattimento. Il Monaco è resistente quanto un guerriero ed è meno imponente, ma può risolvere alcuni problemi più velocemente e non dipende molto dall'equipaggiamento.
...
I Ranger possono possedere solo i beni che possono portare con sé. Essi dovrebbero regalare tesori extra a cause meritevoli. Non più di due Ranger possono avventurarsi insieme in un gruppo.
