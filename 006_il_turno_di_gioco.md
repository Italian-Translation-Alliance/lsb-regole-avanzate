...
Sebbene l'esplorazione tenda ad essere risolta in modo più sciolto e libero rispetto al combattimento, dove la descrizione e la negoziazione sono centrali e le regole predefinite hanno un ruolo di secondo piano, ci sono comunque alcune procedure standard che aiuteranno l'Arbitro nello svolgimento di queste attività in modo efficiente.

### Perlustrare un Dungeon

Molte avventure de *La Scatola Bianca* coinvolgeranno i personaggi nell'esplorazione di qualche area chiusa, che siano i sotterranei sotto un castello o un tempio, un sistema di grotte e caverne naturali, una miniera abbandonata, le fogne sotto una città, una fortezza nemica, la torre di un mago o un santuario dedicato a qualche dio oscuro. Per comodità, e per tradizione, questi luoghi chiusi sono chiamati collettivamente "dungeon", che quindi si riferisce non solo ad un insieme di tunnel artificiali ma a qualsiasi luogo di avventura al chiuso. Dato che le avventure di questo tipo hanno caratteristiche simili, l'insieme di procedure e meccaniche di risoluzione suggerite di seguito si applica alla maggior parte di esse.
...
2. **Dichiarare l'azione**: Ogni giocatore descrive l'attività con i vari membri del gruppo, le quali vengono risolte come appropriato dall'Arbitro:
...
L'unità di tempo di base per l'esplorazione nella natura è il giorno. È una buona idea, se possibile, che l'Arbitro utilizzi una carta contrassegnata da una griglia esagonale ("carta esagonale") per pre-disegnare le mappe della regione selvaggia prima che i giocatori la esplorino.
